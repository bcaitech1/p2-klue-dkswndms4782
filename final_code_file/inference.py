...
if __name__ == '__main__':
  ...
  # model dir
  parser.add_argument('--model_dir', type=str, default="/opt/ml/code/results/electra/checkpoint-2700")
  parser.add_argument('--out_path', type=str, default="/opt/ml/code/prediction/submission.csv")
  parser.add_argument('--model_type', type=str, default="Electra")
  parser.add_argument('--pretrained_model', type=str, default="electra-base-discriminator")
